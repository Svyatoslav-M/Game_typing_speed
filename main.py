...
#Window sizes 700x400
WIDTH, HEIGHT = 700, 400

#Adding Win and Lose Sounds
...
def avr_speed(text, times):
    ...
    if times/len(text) <= 0.3:
        ...
        return "You are very fast, your average speed is " + speed + " second ped character"
    else:
        SCORE = 0
        pygame.mixer.Sound.play(MUS_LOSE)
        return "You are very slow, your average speed is " + speed + " second ped character"

#Display the text of the win/lose on the screen
def draw_win(text):
